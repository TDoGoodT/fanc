...
struct _T_Relop : public _T_Exp {
    ...
    _T_Relop(struct _T_Exp *l_exp, struct _T_Exp *r_exp, RelopCase relopCase) : rExp(r_exp), lExp(l_exp), nextList(),
                                                                                breakList(), continueList(), trueList(),
                                                                                falseList(),
                                                                                _T_Exp(new _T_Type(_T_Type::_BOOL_)),
                                                                                relopCase(relopCase) { accept(); }
